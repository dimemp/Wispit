/* Services card hover animations (3 canvases).
   ...
   - Accent colour is orange #FF5600; the "gradient" appearance comes from
...
(function () {
  ...
  function initCard2() {
    ...
    function drawLayerAnimated(layer, alpha, slideY) {
      ...
      ctx.fillText(layer.label, 0, 0); ctx.restore();
      ctx.restore();
      // Accent edge outline intentionally omitted — layer fill + grey base
      // stroke define the shape, and the dotted corner connectors below
      // carry the accent colour without saturating the whole card.
    }
